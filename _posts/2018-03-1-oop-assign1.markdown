...
##### CLOCKWISE - 오른쪽 grid에서 i가 column보다 작은 부분 (i<column)
...
##### CLOCKWISE - 오른쪽 grid에서 i가 column보다 큰 부분 (i>=column)
이번엔 l을 살펴보자.
...
##### COUNTER-CLOCKWISE - 오른쪽 grid에서 i가 column보다 작은 부분 (i<column)

(j+1, column-i+j)

##### COUNTER-CLOCKWISE - 오른쪽 grid에서 i가 column보다 큰 부분 (i>=column)
