...
다만 이 방법은 단어의 철자를 확인하는 과정이 번거롭다.
예외처리도 해주어야하고,  
char 하나하나 확인해야하기 때문이다.  

사실 코드가 그렇게 길지도 않고 복잡하지도 않다.

자세한 이야기는 다음 링크에서 하겠다.
[모두탐색](https://bleetoteelb.github.io/devlog/2018/03/04/oop-assign1-1/)
