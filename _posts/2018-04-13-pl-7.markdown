...
다음과 같은 조건을 만족할 때 __일급 객체__라고 말할 수 있다.  
- __변수__나 __데이터 구조__안에 담을 수 있다.  
- __파라미터__로 전달 할 수 있다.  
- __반환값(return value)__으로 사용할 수 있다.  
- 할당에 사용된 이름과 관계없이 __고유한 구별__이 가능하다.  

  

쉽게말해,  
__First-class function__은 어디에서나 value로 사용될 수 있는 함수를 말한다.   
다음 예제를 보자.
